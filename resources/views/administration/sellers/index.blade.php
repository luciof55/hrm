				...
				<div class="p-2 text-black border-bottom bg-light">
					<form id="actionForm" action="{{$action}}" metdod="GET">
						...
						<div class="d-flex flex-row bg-light">
							...
							<div class="p-1">
								<div class="d-flex flex-row">
									<div class="p-1"><label for="interviews-account_id_filter" class="col-form-label text-md-right">@lang('messages.Account')</label></div>
									<div class="p-1">
									...
									<div class="p-1"><label for="interview-zonas_filter" class="col-form-label text-md-right">@lang('messages.Zonas')</label></div>
									<div class="p-1"><input class="form-control" type="text" placeholder="@lang('messages.Zonas')" id="interviews-zonas_filter" name="interviews-zonas_filter" value="{{ $filters->get('interviews-zonas_filter') }}"></div>
								
									<div class="p-1"><label for="interview-anio_filter" class="col-form-label text-md-right">@lang('messages.Anio')</label></div>
									<div class="p-1">
