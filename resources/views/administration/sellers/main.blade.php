			...
			@if (!blank($command->files))
				<div class="form-group row">
					...
					<div class="col-md-6">
						...
						<button id="button_remove_file" type="button" onclick="sellerInstance.removeFile('fileForm', 'POST', '{{$action_removefile}}');" class="btn btn-danger btn-md"><i class="pr-2 fa fa-remove delete-button"></i>@lang('messages.Remove')</button>
