	...
	@if ($btn_new && Gate::allows('create', $entity))
		<button id="button_new" type="button" onclick="crudInstance.create('{{route($actionCreate)}}');" class="btn btn-info btn-md">@lang('messages.New')</button>
	@endif
	@if ($btn_view && Gate::allows('view', $entity))
		<button id="button_view" type="button" onclick="crudInstance.view('{{$entity}}', '{{$actionView}}');" class="btn btn-info btn-md disabled">@lang('messages.View')</button>
	@endif
	@if ($btn_edit && Gate::allows('edit', $entity))
		<button id="button_edit" type="button" onclick="crudInstance.edit('{{$entity}}', '{{$actionEdit}}');" class="btn btn-info btn-md disabled">@lang('messages.Edit')</button>
	@endif
