...
Route::get('contacts/export', 'Administration\ContactController@export')->middleware('checkprivilege:contacts')->middleware('owner.authorize:\App\Model\Administration\Contact,export')->name('contacts.export');
...
Route::get('businessrecordstates/export', 'Administration\BusinessRecordStateController@export')->middleware('checkprivilege:businessrecordstates')->name('businessrecordstates.export');
