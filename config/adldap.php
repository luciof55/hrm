            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'localhost')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=topgroup,dc=com,dc=ar'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'user'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'user'),
